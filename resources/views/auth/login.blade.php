...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=Fraunces:opsz,wght@9..144,600&display=swap" rel="stylesheet">
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; }
        ...
        :root {
            ...
            --brass:      #c9a961;
            --brass-soft: #e3cb8e;
            --brass-bdr:  rgba(201,169,97,0.30);
            --text-1:     #eef2ff;
            --text-2:     #94a3b8;
            --text-3:     #475569;
        ...
        .login-card::before {
            ...
            height: 2px;
            background: linear-gradient(90deg, var(--brass) 0%, var(--blue-400) 65%, transparent);
        }
...
<div class="login-wrap">
    ...
    <div class="login-logo">
        <span class="login-logo-icon"><i class="ti ti-wallet"></i></span>
